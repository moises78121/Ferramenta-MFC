...
function showPEC_puericultura() {
	...
	document.getElementById("page_text_content").innerHTML = `
		...
		<br>
		<p>
			REGISTRO AO NASCER: TIPO DE PARTO..., IG S+D, COMPRIMENTO CM, PERÍMETRO CEFÁLICO CM, PERÍMETRO TORÁCICO CM, PERÍMETRO ABDOMINAL CM, PESO G, APGAR 1' , APGAR 5' .<br>
			PESO ALTA G.<br>
			FOI REALIZADO:<br>
			...
			REGISTRO AO NASCER: PERÍMETRO TORÁCICO CM, PERÍMETRO ABDOMINAL CM;<br>
			PESO DA ALTA G;<br>
